...
class ModulitUnittest(unittest.TestCase):
    def setUp(self):
        ...
        self.base_url = "http://vogels.installog.ru/"
        self.verificationErrors = []
        self.accept_next_alert = True
    
    def test_modulit_unit(self):
        driver = self.driver
        driver.get(self.base_url + "/login?ReturnUrl=%2fcustomer%2ffiles")
        driver.find_element_by_id("Email").clear()
        driver.find_element_by_id("Email").send_keys("mas@av-prom.ru")
        driver.find_element_by_id("Password").clear()
        driver.find_element_by_id("Password").send_keys("Av02")
        driver.find_element_by_css_selector("input.button-1.login-button").click()
